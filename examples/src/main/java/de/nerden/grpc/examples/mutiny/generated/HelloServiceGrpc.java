...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "de.nerden.grpc.examples.mutiny.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<de.nerden.grpc.examples.mutiny.generated.HelloRequest,
      de.nerden.grpc.examples.mutiny.generated.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = de.nerden.grpc.examples.mutiny.generated.HelloRequest.class,
      responseType = de.nerden.grpc.examples.mutiny.generated.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<de.nerden.grpc.examples.mutiny.generated.HelloRequest,
      de.nerden.grpc.examples.mutiny.generated.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<de.nerden.grpc.examples.mutiny.generated.HelloRequest, de.nerden.grpc.examples.mutiny.generated.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<de.nerden.grpc.examples.mutiny.generated.HelloRequest, de.nerden.grpc.examples.mutiny.generated.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  de.nerden.grpc.examples.mutiny.generated.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  de.nerden.grpc.examples.mutiny.generated.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(de.nerden.grpc.examples.mutiny.generated.HelloRequest request,
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public de.nerden.grpc.examples.mutiny.generated.HelloResponse hello(de.nerden.grpc.examples.mutiny.generated.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<de.nerden.grpc.examples.mutiny.generated.HelloResponse> hello(
        de.nerden.grpc.examples.mutiny.generated.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((de.nerden.grpc.examples.mutiny.generated.HelloRequest) request,
              (io.grpc.stub.StreamObserver<de.nerden.grpc.examples.mutiny.generated.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return de.nerden.grpc.examples.mutiny.generated.HelloServiceOuterClass.getDescriptor();
    }
